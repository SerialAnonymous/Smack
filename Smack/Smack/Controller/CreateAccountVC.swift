...
class CreateAccountVC: UIViewController {
    ...
    func setUpView(){
        ...
        emailTxt.attributedPlaceholder = NSAttributedString(string: "Enter Email id", attributes: [NSAttributedStringKey.foregroundColor:SMACK_PURPLE_PLACEHOLDER])
        passTxt.attributedPlaceholder = NSAttributedString(string: "Enter Password", attributes: [NSAttributedStringKey.foregroundColor:SMACK_PURPLE_PLACEHOLDER])
